...
namespace DX
{
    ...
    public:
        ...
        DXGI_FORMAT GetDepthBufferBindableFormat() const noexcept { return m_depthBufferFormatBindable; }
        unsigned int GetSampleCount() const noexcept { return m_sampleCount; }

    private:
        void ValidateSampleCount( ID3D11Device *device );
        ...
        DXGI_FORMAT                                         m_depthBufferFormatTypeless;
        DXGI_FORMAT                                         m_depthBufferFormatBindable;
